            ...
            <div className="fixed inset-0 z-[100] flex flex-col items-center overflow-y-auto scrollbar-hide py-10" style={{ backgroundColor: '#4ab86d' }}>
                ...
                {showTicket && (
                    <div className="max-w-md w-full px-4 pt-8 ticket-fade z-20">
                        ...
                        {/* Action buttons */}
                        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center pb-8 print:hidden">
                            <button
                                onClick={() => navigate("/", { state: { scrollTo: 'pnr-section', pnr: bookingResult?.pnr } })}
                                className="bg-white font-bold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition duration-300 w-full sm:w-auto text-center"
                                style={{ color: '#4ab86d' }}
                            >
                                Check PNR Status
                            </button>
                            <button
                                ...
                                className="bg-[#4ab86d] text-white font-bold py-3 px-6 rounded-xl shadow-lg hover:bg-green-600 hover:shadow-xl hover:-translate-y-1 transition duration-300 w-full sm:w-auto flex items-center justify-center gap-2"
                            >
